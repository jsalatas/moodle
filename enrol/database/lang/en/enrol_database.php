...
$string['templatecourse'] = 'New course template field';
$string['templatecourse_desc'] = 'Optional: auto-created courses can copy their settings from a template course. This can be either a database field which contains the shortname of the template course or the shortname of the template.';
$string['templateisdbfield'] = 'Template is database field';
$string['templateisdbfield_desc'] = 'If checked the new course template field will be treated as the name of a database field which contains the shortname of the template course ';
